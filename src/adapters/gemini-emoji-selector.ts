...
const SYSTEM_INSTRUCTION = [
  ...
  "Treat each emoji as a reaction from another person reading the message, not as a literal label for words, objects, roles, or activities mentioned in it.",
  "Prefer the social or conversational response a teammate would naturally give: acknowledgement, appreciation, curiosity, caution, support, or celebration when appropriate.",
  "Avoid choosing an emoji only because its name or image resembles a keyword or object in the message.",
